...
EXP=/Serverless/iccd/experiments/20260528-phys8g-silo-ours-toggle-w5-vmstat
...
stage_guest() {
  ...
  copy_file /Serverless/iccd/scripts/run_local_util_adapt_experiment.sh /root/scripts/run_local_util_adapt_experiment.sh
  copy_file /Serverless/iccd/scripts/local_util_adapt_controller.py /root/scripts/local_util_adapt_controller.py
  copy_file "/Serverless/iccd/experiments/20260528-phys8g-allworkloads-ours-toggle-w5/guest/run_all_workloads_phys8g_ours_toggle_w5_guest.sh" /root/scripts/run_all_workloads_phys8g_ours_toggle_w5_guest.sh
...
remote 'rm -rf /root/phys8g-allworkloads-ours-toggle-w5'
remote 'OUTROOT=/root/phys8g-allworkloads-ours-toggle-w5 WORKLOADS="silo" TIMEOUT_SEC=3600 /root/scripts/run_all_workloads_phys8g_ours_toggle_w5_guest.sh' \
