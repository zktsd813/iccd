...
stage_guest() {
  ...
  copy_file "${EXP}/guest/run_all_workloads_phys8g_ours_toggle_w5_guest.sh" /root/scripts/run_all_workloads_phys8g_ours_toggle_w5_guest.sh
...
remote 'OUTROOT=/root/phys8g-allworkloads-ours-toggle-w5 WORKLOADS="pr bc silo liblinear FT LU SP gups graph500 btree xsbench" TIMEOUT_SEC=3600 /root/scripts/run_all_workloads_phys8g_ours_toggle_w5_guest.sh' \
